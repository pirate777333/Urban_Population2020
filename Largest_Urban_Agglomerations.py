...
df = pd.read_csv('D:/rektorov_rad/programirano/Urbano/08509bf3-5965-45b1-8cc6-3f111cba0994_Data.csv')
df=df.iloc[:-52,2:-1]
#print(df.tail(10))
...
fig=px.bar(df.iloc[0:10],y='2019',x='Country Name',color='Country Name',
           text='2019',template='plotly_dark',title='(Highest) Population Urban Agglomeration (greater than 1 mil)')
fig.show()
...
fig=px.bar(df.iloc[0:10],y='2019',x='Country Name',color='Country Name',
           text='2019',template='plotly_dark',title='(Lowest) Population Urban Agglomeration (greater than 1 mil)')
fig.show()
...
def specific_country(country_name):
    ...
    fig=px.bar(y=data,x=year,color=year,
           template='plotly_dark',title=country_name+' Population Urban Agglomeration (greater than 1 mil)',
           labels=dict(x="Years", y="Population Urban Agglomeration (greater than 1 mil)", color="Years"))
    fig.show()
    fig=px.line(y=data,x=year,
           template='plotly_dark',title=country_name+' Population Urban Agglomeration (greater than 1 mil)',
           labels=dict(x="Years", y="Population Urban Agglomeration (greater than 1 mil)"))
    fig.show()
...
fig=px.bar(df.iloc[0:10],y='90_19',x='Country Name',color='Country Name',
           text='90_19',template='plotly_dark',title='(Highest) Population Urban Agglomeration growth in % (greater than 1 mil)')
fig.show()
...
fig=px.bar(df.iloc[0:10],y='90_19',x='Country Name',color='Country Name',
           text='90_19',template='plotly_dark',title='(Lowest) Population Urban Agglomeration growth in % (greater than 1 mil)')
fig.show()
